        ...
        <div className="login-area md:w-1/2 w-full bg-[#17171a] rounded-b-[15px] md:rounded-r-[15px] opacity-90 p-3 md:p-10 mb-0">
          ...
          >
            <div className="form-header text-center pb-5">
              <h2 className="text-2xl md:text-[2rem] font-bold text-slate-100">
                Welcome back!
              </h2>
            ...
            <div className="form-content flex flex-col items-center justify-center pt-4 gap-5 w-full">
              ...
              <button
                type="submit"
                className="bg-[#7770e0] hover:bg-[#635cc4] px-5 py-3 w-full rounded-[7px] text-white mt-5 text-md md:text-lg"
              >
                {showLoader ? <Loader height="30" width="30" /> : "Log-in"}
              </button>
            </div>
          </form>
        </div>
